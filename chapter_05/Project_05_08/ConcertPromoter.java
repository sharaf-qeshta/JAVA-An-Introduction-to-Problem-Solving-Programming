...
public class ConcertPromoter
{
    ...
    public ConcertPromoter(String bandName_, int venueCapacity_,
                           double priceOfTicketOnPhone_,
                           double priceOfTicketOnConcertVenue_)
    {
        bandName = bandName_;
        venueCapacity = venueCapacity_;
        priceOfTicketOnConcertVenue = priceOfTicketOnConcertVenue_;
        priceOfTicketOnPhone = priceOfTicketOnPhone_;
    }
